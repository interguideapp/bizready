...
export const EMPLOYMENT_TASKS: TaskTemplate[] = [
  {
    ...
    after_submit:
      "שמרו את מספרי התיקים — הם נדרשים לכל דיווח שכר. מכאן אפשר להריץ שכר כחוק: תלושים, העברת הניכויים לרשויות והפרשות פנסיה לעובדים.",
    pitfalls: [
...
4. שמרו את מספרי התיקים — תצטרכו אותם לכל דיווח שכר`,
  ...
  },
  {
    ...
    category_id: "employment",
    pitfalls: [
      "לא למסור הודעה בכתב תוך 30 יום (לנוער — 7 ימים) — אי-מסירה חושפת לתביעה ולקנס.",
      "לשכוח לעדכן הודעה כשמשתנים תנאים — נדרשת הודעה מעודכנת תוך 30 יום.",
    ],
...
4. שמרו את הדוחות לפחות 7 שנים`,
  ...
  },
  {
    ...
    category_id: "employment",
    after_submit:
      "כל חודש מופק תלוש, השכר משולם עד ה-9 בחודש העוקב, והניכויים מועברים למס הכנסה ולביטוח לאומי. שמרו כל תלוש בתיק העובד — המערכת תזכיר לכם על מחזור השכר החודשי.",
    pitfalls: [
...
4. העבירו ניכויים למס הכנסה ולביטוח לאומי בזמן`,
  ...
  },
  {
    ...
    category_id: "employment",
    pitfalls: [
      "לא לבדוק אם לעובד יש קרן פעילה — עם קרן קיימת ההפרשות מתחילות כמעט מיד, לא אחרי 6 חודשים.",
      "לאחר בהפרשות — זה חוב שנצבר עם ריבית וקנסות.",
    ],
...
4. שמרו אישורי הפקדה`,
  ...
  },
  {
    ...
    category_id: "employment",
    pitfalls: [
      "להסתמך רק על ביטוח לאומי — עובד שנפגע יכול לתבוע אתכם ישירות מעבר לכך; חבות מעבידים מכסה את זה.",
      "לא לכלול את כל סוגי העובדים (כולל זמניים) בפוליסה.",
    ],
...
4. עדכנו מכסות עם עליית הוותק`,
  ...
  {
    id: "employer-monthly-102",
    category_id: "employment",
    title: "דיווח ניכויים חודשי (טופס 102)",
    why: "פתחתם תיק ניכויים — טופס 102 הוא מה שהתיק הזה קיים בשבילו. כל חודש מדווחים ומעבירים את המס והניכויים שקוזזו מהשכר, גם למס הכנסה וגם לביטוח לאומי. איחור גורר קנסות פיגורים והצמדה, ובשונה מדוח שנתי — זה חוזר 12 פעמים בשנה.",
    steps: `1. הריצו את השכר לחודש שחלף וקבלו מתוכנת השכר את סכומי הניכויים
2. **ביטוח לאומי:** דווחו ושלמו באתר התשלומים של ביטוח לאומי, דרך תוכנת השכר או דרך המייצג
3. **מס הכנסה:** דווחו ושלמו את הניכוי במקור שקוזז מהמשכורות באותו חודש
4. שמרו את האישורים — הם הבסיס לדוח השנתי (טופס 126) ולהתאמות מול הרשויות
5. אם באותו חודש לא הייתה משכורת — עדיין צריך לדווח דיווח אפס, לא לדלג`,
    after_submit:
      "הדיווח החודשי מצטבר לדוח השנתי: טופס 126 מסכם את כל 12 הדיווחים. אם יש פער בין הדיווחים החודשיים לדוח השנתי — זה מה שהרשויות בודקות, ולכן שווה לשמור כל אישור.",
    pitfalls: [
      "לדלג על חודש בלי משכורת במקום לדווח דיווח אפס — הרשות רואה חודש חסר, לא חודש ריק.",
      "לדווח לביטוח לאומי ולשכוח את הדיווח למס הכנסה (או להיפך) — אלה שני דיווחים נפרדים באותו טופס.",
      "להתבלבל בין מועד הדיווח לניכויים (15 בחודש) למועד מקדמות ביטוח לאומי לעצמאי (22 בחודש) — שני תאריכים שונים.",
    ],
    official_links: [
      { label: "דיווח ותשלום עבור עובדים — ביטוח לאומי", url: "https://www.btl.gov.il/Insurance/Maasik/MToshavYisrael/DivuahVetashlum/Pages/Divuhach.aspx" },
      { label: "תשלום ביטוח לאומי לשכירים (טופס 102) — gov.il", url: "https://www.gov.il/he/service/socialsecuritypaymentforemployees" },
    ],
    docs_needed: ["דוח ניכויים מתוכנת השכר", "מספר תיק הניכויים"],
    est_cost: "התשלום עצמו תלוי בשכר; הדיווח חינם",
    ...
    recurrence: "monthly",
    priority: "critical",
    source_url: "https://www.btl.gov.il/Insurance/Maasik/MToshavYisrael/DivuahVetashlum/Pages/Divuhach.aspx",
    last_reviewed: REVIEWED,
    sort_order: 9,
  },
  {
    id: "employer-annual-126",
    category_id: "employment",
    title: "דיווח שנתי על ניכויים (טופס 126 ו-856)",
    why: "סיכום שנתי של כל מה שניכיתם: טופס 126 על משכורות ושכר עבודה, וטופס 856 על תשלומים שאינם משכורת (ספקים ונותני שירותים שניכיתם מהם מס במקור). הדיווח מקוון בלבד, והוא מה שמאפשר לעובדים שלכם לקבל החזרי מס.",
    steps: `1. הפיקו מתוכנת השכר את קובץ 126 לשנת המס שחלפה
2. אם ניכיתם מס במקור מספקים או נותני שירותים — הפיקו גם קובץ 856
3. שדרו את הקבצים במערכת המקוונת של רשות המסים (הגשה מקוונת בלבד)
4. הריצו את הבדיקות הלוגיות של רשות המסים לפני השידור — הן תופסות שגיאות שיחזירו לכם את הדוח
5. קבלו אישור הגשה במערכת אישור ההגשה ושמרו אותו
6. **בנוסף:** ביטוח לאומי דורש 126 גם באמצע השנה — עד 18 ביולי עבור ינואר–יוני, ועד 18 בינואר עבור השנה שקדמה`,
    after_submit:
      "אחרי השידור מקבלים אישור הגשה במערכת המקוונת. שמרו אותו: הוא ההוכחה שהדוח הוגש במועד. פערים בין הדיווחים החודשיים (102) לדוח השנתי הם מה שנבדק בפועל.",
    pitfalls: [
      "להגיש 126 ולשכוח 856 — מי שניכה מס במקור מספקים חייב בשניהם.",
      "לשדר בלי להריץ קודם את הבדיקות הלוגיות, ואז לקבל את הדוח חזרה עם שגיאות אחרי המועד.",
      "לחשוב שדיווח 126 למס הכנסה פוטר מהדיווח לביטוח לאומי — ביטוח לאומי דורש 126 גם ב-18 ביולי וב-18 בינואר.",
    ],
    official_links: [
      { label: "שידור דוחות 126 ו-856 — רשות המסים", url: "https://www.gov.il/he/service/report126" },
      { label: "מערכת אישור הגשה (126/856) — רשות המסים", url: "https://www.gov.il/he/service/serving-approval-system" },
      { label: "שליחת טופס 126 — ביטוח לאומי", url: "https://www.btl.gov.il/Insurance/Maasik/Pages/Tofes126.aspx" },
    ],
    docs_needed: ["קובץ 126 מתוכנת השכר", "קובץ 856 (אם ניכיתם מספקים)", "אישור הגשה"],
    est_cost: "חינם (לרוב נכלל בשירות של הנהלת החשבונות)",
    ...
    recurrence: "yearly",
    priority: "critical",
    source_url: "https://www.gov.il/he/service/report126",
    last_reviewed: REVIEWED,
    sort_order: 10,
  },
];
