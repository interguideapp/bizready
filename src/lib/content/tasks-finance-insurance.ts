...
export const FINANCE_INSURANCE_TASKS: TaskTemplate[] = [
  // ============ פיננסים ============
  {
    ...
    category_id: "finance",
    after_submit:
      "מכאן נתבו את כל הכנסות והוצאות העסק דרך החשבון הזה בלבד. פרטי החשבון שנשמרו בכרטיס העסק יופיעו בתיק העסק — והחשבון הוא תנאי מקדים לפתיחת סליקה.",
    pitfalls: [
      "לערבב כספי עסק ובית באותו חשבון — הופך את הנהלת החשבונות והצהרת ההון לסיוט.",
      "לפתוח \"חשבון עסקי\" יקר כשלא חייבים — לעוסק פטור/מורשה מספיק חשבון פרטי נוסף המיועד לעסק.",
      "לא להשוות עמלות — עצמאי בתחילת דרך יכול לקבל פטורים והנחות.",
    ],
...
5. תייקו את פרטי החשבון בכרטיס העסק`,
  ...
  },
  {
    ...
    category_id: "finance",
    after_submit:
      "אישור הסליקה לוקח לרוב כמה ימי עסקים — סמנו כ\"ממתין\" עד שיאושר. אחרי האישור חברו את הסליקה לתוכנת החשבוניות כדי שתופק קבלה אוטומטית על כל תשלום.",
...
4. עדכנו את הטבלה פעם בחודש — באותו מפגש חודשי של ניהול הספרים`,
  ...
  },
  {
    ...
    category_id: "finance",
    after_submit:
      "אחרי פתיחת הקרן וההוראת קבע ההפקדות שוטפות. שמרו את אישור ההפקדה השנתי — הוא מזכה בהחזר מס בדוח השנתי. רכיב הנכות בקרן יכול לשמש בסיס לביטוח אובדן כושר עבודה.",
    pitfalls: [
      "לא לדעת שזו חובה חוקית (מ-2017) ולא רק המלצה — אי-הפקדה חושפת לקנס ומפספסת הטבת מס.",
      "לשלם דמי ניהול גבוהים — השוואה בין הקרנות (כולל קרנות ברירת המחדל הזולות) חוסכת הרבה לאורך זמן.",
      "לא לשמור את אישור ההפקדה השנתי — הוא שווה החזר מס בדוח השנתי.",
    ],
...
2. שיעורי החובה (2026): 4.45% מההכנסה עד מחצית השכר הממוצע ({{averageWage}} לחודש), ו-12.55% מהחלק שבין מחצית לשכר הממוצע המלא
...
4. נצלו את התקרה לפני סוף שנת המס`,
  ...
  },
  {
    ...
    category_id: "finance",
    pitfalls: [
      "לבזבז את כל ההכנסה כאילו היא נטו — המס לא יורד אוטומטית כמו אצל שכיר, וההפתעה בסוף השנה כואבת.",
      "להפריש מעט מדי — כלל אצבע למתחיל: 25%–35% מכל הכנסה לחשבון/פיקדון נפרד.",
    ],
...
4. מה שנשאר עודף — הפקידו לפנסיה/השתלמות וקבלו הטבת מס`,
  ...
  // ============ ביטוח ומשפט ============
  {
    ...
    after_submit:
      "אחרי הרכישה תייקו את הפוליסה ותאריך החידוש. הכיסוי מתחדש כל שנה — המערכת תזכיר לכם לפני שהוא פג, כדי שלא יהיה אף יום בלי כיסוי.",
    pitfalls: [
      "לא לבדוק תקופת גילוי רטרואקטיבית — תביעה על עבודה מלפני שנים עלולה לא להיות מכוסה.",
      "לתת לפוליסה לפוג בלי חידוש — יום אחד בלי כיסוי יכול לעלות ביוקר. תייקו את תאריך החידוש.",
      "לבחור גבול אחריות נמוך מדי כדי לחסוך בפרמיה — ואז הכיסוי לא מספיק כשצריך.",
    ],
...
4. תייקו את הפוליסה בארכיון עם תאריך החידוש`,
  ...
  },
  {
    ...
    category_id: "insurance-legal",
    pitfalls: [
      "לעבוד מהבית ולהניח שביטוח הדירה מכסה — הוא לא מכסה פעילות עסקית; צריך הרחבה/פוליסה ייעודית.",
      "לא לבטח למרות קבלת קהל — לקוח שמחליק או נפגע מציוד שלכם, האחריות עליכם.",
    ],
    title: "ביטוח צד ג'",
...
4. ההפרמיה מוכרת חלקית כהוצאה — שמרו אישורים לדוח השנתי`,
  ...
  },
  {
    ...
    category_id: "insurance-legal",
    pitfalls: [
      "להתחיל עבודה בלי אישור בכתב — גם וואטסאפ/מייל עדיף מכלום; מונע 90% מהסכסוכים.",
      "לא להגדיר מדיניות ביטולים ותנאי תשלום מראש — שם נופלות רוב אי-ההבנות.",
      "לשכוח סעיף קניין רוחני בעבודות יצירה/פיתוח — בלעדיו הלקוח עלול לטעון לבעלות מלאה.",
    ],
...
4. עדכנו כשמשהו משתנה במודל העסקי`,
  ...
  },
  {
    ...
    category_id: "insurance-legal",
    after_submit:
      "אחרי הפרסום באתר ובטופסי איסוף הפרטים, שמרו עותק בארכיון. עדכנו את המדיניות בכל פעם שסוג המידע שאתם אוספים או מטרת האיסוף משתנים.",
    pitfalls: [
      "לאסוף יותר מידע ממה שצריך — פחות מידע = פחות סיכון וחשיפה לעיצומים לפי תיקון 13.",
      "לכתוב מדיניות ולא לפרסם אותה בפועל באתר ובכל טופס איסוף פרטים.",
      "להתעלם מזכויות העיון והתיקון — הן חובה, וצריך דרך יצירת קשר ברורה למימושן.",
    ],
