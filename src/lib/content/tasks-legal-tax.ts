...
export const LEGAL_TAX_TASKS: TaskTemplate[] = [
  // ============ הקמה ורישום ============
  {
    ...
    after_submit:
      "בסיום מקבלים תעודת עוסק עם מספר העוסק — לרוב מיידית ועד כמה ימי עסקים. שמרו אותה: תצטרכו אותה לפתיחת חשבון בנק עסקי, לחיבור סליקה ומול לקוחות. עוסק מורשה — מכאן נפתחת חובת דיווח מע\"מ תקופתי.",
    pitfalls: [
    ...
    steps: `1. ודאו שבחרתם נכון בין עוסק פטור (מחזור עד {{osekPaturCeiling}} בשנת 2026) לעוסק מורשה
...
5. שמרו את תעודת העוסק שתקבלו — תצטרכו אותה מול הבנק ולקוחות`,
  ...
  },
  {
    ...
    category_id: "legal-setup",
    after_submit:
      "בפתיחה מקוונת התיק נפתח יחד עם תיק המע\"מ ומופיע באזור האישי ברשות המסים. ייתכן שייקבעו לכם מקדמות מס — בדקו זאת והסדירו במשימת המקדמות.",
    pitfalls: [
...
4. בדקו אם נקבעו לכם מקדמות מס (ראו משימה נפרדת)`,
  ...
  },
  {
    ...
    category_id: "legal-setup",
    after_submit:
      "אחרי הרישום נקבעות מקדמות חודשיות לפי הצפי שמסרתם, והתשלום הראשון נכנס לגבייה. אם ההכנסה בפועל שונה מהצפי — עדכנו את גובה המקדמה כדי לא לשלם יותר מדי ולא לצבור חוב.",
    pitfalls: [
...
4. בדקו את גובה המקדמות החודשיות שנקבעו לכם והתאימו אותן להכנסה הצפויה`,
  ...
  },
  {
    ...
    category_id: "legal-setup",
    after_submit:
      "אחרי הגשת הבקשה הרשות בודקת אותה (ולעיתים גם גורמים נוספים — כבאות, משרד הבריאות). זה יכול לקחת שבועות עד חודשים — סמנו את המשימה כ\"ממתין\" עם תאריך לבדיקת סטטוס. בדקו אם מגיע לכם היתר מזורז כדי להתחיל לפעול עד קבלת הרישיון המלא.",
    pitfalls: [
...
5. תייקו את פרטי איש המקצוע בכרטיס העסק`,
  ...
  },
  {
    ...
    category_id: "tax",
    after_submit:
      "אחרי ההגדרה אפשר להוציא מסמכים מיד. עוסק מורשה — לאחר החיבור ל\"חשבוניות ישראל\", חשבונית מעל הסף תקבל מספר הקצאה אוטומטית בעת ההפקה. שמרו עותק של כל מסמך — חובת שמירה 7 שנים.",
    pitfalls: [
      "עוסק מורשה שלא חיבר את התוכנה למערכת \"חשבוניות ישראל\" — הלקוח לא יוכל לקזז מע\"מ על חשבונית מעל {{invoiceAllocationThreshold}} (לפני מע\"מ, מיוני 2026).",
...
3. **מורשה:** הפעילו בתוכנה את החיבור למערכת "חשבוניות ישראל" — מיוני 2026 כל חשבונית מעל {{invoiceAllocationThreshold}} (לפני מע"מ) חייבת מספר הקצאה
...
5. שמרו הכל 7 שנים לפחות`,
  ...
  },
  {
    ...
    category_id: "tax",
    after_submit:
      "התשלום מתבצע דרך אתר רשות המסים ומתקזז מול המס בדוח השנתי. אם ההכנסה בפועל נמוכה מהצפי — הגישו בקשה להקטנת מקדמות כדי לא להשאיר כסף תקוע עד הדוח.",
    pitfalls: [
...
4. בסוף השנה המקדמות מתקזזות מול המס בדוח השנתי`,
  ...
  },
  {
    ...
    category_id: "tax",
    after_submit:
      "אחרי השידור מתקבלת אסמכתת הגשה, והתשלום (או ההחזר) מתבצע. שמרו את האסמכתא בארכיון. הדיווח חוזר כל תקופה — המערכת תזכיר לכם לקראת המועד הבא.",
    pitfalls: [
...
5. גם בחודש בלי פעילות חובה לדווח (דיווח אפס)`,
  ...
  },
  {
    ...
    category_id: "tax",
    after_submit:
      "אחרי השידור מתקבלת אסמכתה. אם הופקדתם לפנסיה/קרן השתלמות או נוכה לכם מס במקור — כאן מתקבל החזר המס שמגיע לכם. שמרו את שידור הדוח בארכיון.",
    pitfalls: [
      "לא לצרף אישורי הפקדה לפנסיה ולקרן השתלמות — מפספסים החזר מס משמעותי שמגיע לכם.",
      "לא לבדוק זכאות ל\"עסק זעיר\" (מחזור עד {{osekPaturCeiling}}) — ניכוי הוצאות אוטומטי של 30% בלי צורך בקבלות.",
...
4. בדקו זכאות ל"עסק זעיר" (מחזור עד {{osekPaturCeiling}}) — ניכוי הוצאות אוטומטי של 30% בלי קבלות
5. שמרו את שידור הדוח והאישור בארכיון`,
  ...
  },
  {
    ...
    category_id: "tax",
    after_submit:
      "האישור מופק מיד באזור האישי. שלחו אותו ללקוחות העסקיים לפני התשלום הראשון ותייקו בארכיון. האישור פג בסוף מרץ בכל שנה — צריך לחדש.",
    pitfalls: [
    ...
    why: "לקוח עסקי חייב לנכות מס מהתשלום אליכם אם אין בידיכם אישור תקף. עם אישור הניכוי הוא {{withholdingRateBase}} מהתשלום, ובלי אישור על ניהול ספרים הוא {{withholdingRateNoCertificate}} — הפרש שיוצא מהתזרים שלכם בכל חשבונית עד שתקבלו את ההחזר בדוח השנתי.",
    steps: `1. הורידו את האישורים מהאזור האישי באתר רשות המסים (מופקים אוטומטית לעוסק חדש ותקין)
2. בדקו את שיעור הניכוי שנקבע לכם — {{withholdingRateBase}} הוא השיעור הרגיל על תשלומים בעד שירותים או נכסים
3. אם לא הוכחתם ניהול ספרים ואין אישור בכתב מפקיד השומה — הניכוי עולה ל-{{withholdingRateNoCertificate}}
4. שלחו את האישור ללקוחות עסקיים לפני התשלום הראשון
5. אם השיעור שנקבע לכם גבוה מדי — אפשר לבקש פטור או הקטנה בטופס 2542
6. חדשו מדי שנה (בדרך כלל בסוף מרץ) ותייקו בארכיון`,
    official_links: [
      { label: "אישורי ניכוי מס במקור — רשות המסים", url: "https://www.gov.il/he/service/itc" },
      {
        label: "מידע על אישורי ניכוי מס במקור וניהול ספרים — רשות המסים",
        url: "https://www.gov.il/he/service/itc-gmishurim",
      },
      {
        label: "בקשה לפטור או הקטנת ניכוי במקור (טופס 2542)",
        url: "https://www.gov.il/he/service/itc2542",
      },
    ],
    docs_needed: [],
    est_cost: "חינם",
  ...
  },
  {
    ...
    why: "חציית התקרה ({{osekPaturCeiling}} ב-2026) בלי מעבר לעוסק מורשה גוררת חיוב מע\"מ רטרואקטיבי על כל מה שמעליה.",
