    ...
    <div dir="rtl" className="mx-auto flex min-h-[60vh] max-w-lg flex-col items-center justify-center px-6 text-center">
      <div className="panel rounded-card w-full p-8">
        ...
        <h1 className="text-title text-ink">
          {isDataUnavailable ? "לא הצלחנו לאמת את המצב שלך" : "משהו השתבש"}
        </h1>

        <p className="mt-3 text-sm leading-relaxed text-ink-soft">
          {isDataUnavailable ? (
            <>
              הנתונים שלך לא נטענו כרגע, ולכן <b className="text-ink">אנחנו לא יכולים להגיד לך שהכול תקין</b>.
              זו תקלה טכנית אצלנו — לא שינוי במצב העסק שלך. נסו לרענן; אם זה חוזר, המידע שלך נשמר במקומו.
            </>
          ) : (
            <>נתקלנו בתקלה בהצגת המסך הזה. הנתונים שלך לא נפגעו.</>
          )}
        </p>
