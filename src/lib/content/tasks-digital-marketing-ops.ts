...
export const DIGITAL_MARKETING_OPS_TASKS: TaskTemplate[] = [
  // ============ רגולציה דיגיטלית ============
  {
    ...
    pitfalls: [
      "להסתמך על \"רכיב נגישות\" (וידג'ט) כאילו הוא פותר הכול — הוא לא פוטר מעמידה בתקן, ובתי משפט אמרו זאת.",
      "לבנות אתר חדש בלי לדרוש נגישות מראש — תיקון בדיעבד עולה פי כמה.",
      "לחשוב שעסק קטן/פטור פטור לגמרי — גם בפטור יש חובת פרסום דרכי התקשרות נגישות.",
    ],
...
3. עדכנו את ההצהרה אחרי כל שינוי משמעותי באתר`,
  ...
  },
  {
    ...
    category_id: "digital-regulation",
    pitfalls: [
      "לשלוח דיוור בלי הסכמה מפורשת ומתועדת — עד ₪1,000 פיצוי לכל הודעה, בלי צורך להוכיח נזק.",
      "צ'קבוקס מסומן מראש אינו הסכמה — ההסכמה חייבת להיות אקטיבית.",
      "לא לכלול בכל הודעה את המילה \"פרסומת\", זהות השולח ודרך הסרה פשוטה וחינמית.",
    ],
...
4. אל תפעילו פיקסלים של שיווק לפני קבלת הסכמה`,
  ...
  // ============ נוכחות דיגיטלית ============
  {
    ...
    after_submit:
      "הדומיין שלכם ורשום על שמכם. מכאן חברו אליו את האתר ואת המייל העסקי (רשומות DNS). החידוש אוטומטי — המערכת תזכיר לפני תאריך החידוש כדי שהדומיין לא ייחטף.",
    pitfalls: [
      "לרשום את הדומיין על המייל של בונה האתרים — ואז הוא בבעלותו, לא שלכם. רשמו על שמכם והמייל שלכם.",
      "לא להפעיל חידוש אוטומטי / לתת לכרטיס לפוג — דומיין שפג תוקפו נחטף תוך ימים.",
      "להתפתות למחיר שנה ראשונה זול שקופץ בחידוש — השוו את מחיר החידוש, לא רק ההרשמה.",
    ],
...
7. תייקו בכרטיס העסק: שם הרשם, המייל של החשבון ותאריך החידוש`,
  ...
  },
  {
    ...
    category_id: "digital-presence",
    pitfalls: [
      "לבנות אתר ענק שלא נגמר — דף נחיתה אחד טוב עדיף על אתר גדול שתקוע.",
      "להזניח מובייל — רוב הגולשים מגיעים מהטלפון; אתר שלא עובד במובייל מבריח לקוחות.",
      "לא לדרוש נגישות (ת\"י 5568) מבונה האתר מראש — תיקון בדיעבד יקר פי כמה.",
    ],
...
6. מעכשיו: כל תקשורת עסקית מהכתובת הזו, והפרידו מהמייל הפרטי`,
  ...
  },
  {
    ...
    category_id: "digital-presence",
    after_submit:
      "גוגל דורש אימות בעלות (קוד בדואר, טלפון או מייל) — עד שמאמתים, הפרופיל לא מוצג. סמנו כ\"ממתין\" עד שהקוד מגיע. אחרי האימות התחילו לבקש ביקורות — הן משפיעות ישירות על הדירוג.",
...
4. שקלו גם כרטיס פיזי מינימלי אם אתם פוגשים לקוחות פנים-אל-פנים`,
  ...
  // ============ תפעול ============
  {
    ...
    pitfalls: [
      "לשכוח שמכל שקל הכנסה יורדים כ-30%–40% למס, ביטוח לאומי ופנסיה — מחיר \"תחרותי\" מדי = לעבוד בחינם.",
      "לחלק את ההוצאות בכל השעות במקום בשעות המחויבות ללקוח בפועל (שיווק ואדמיניסטרציה לא מחויבים).",
      "עוסק מורשה שלא מבהיר אם המחיר כולל מע\"מ — מוביל לאי-הבנות מול הלקוח.",
    ],
...
7. עדכנו מחירון אחת לשנה לפחות, ותמיד כשעלויות עולות`,
  ...
  },
  {
    ...
    category_id: "operations",
    pitfalls: [
      "להוציא חשבונית/קבלה \"בסוף החודש\" במקום מיד עם התשלום — מוביל להכנסות שלא נרשמו ולבלגן.",
      "לא לקבוע יום קבוע למעקב גבייה — חובות פתוחים נשכחים והופכים לכסף שלא נגבה.",
    ],
...
4. את המסמכים הרשמיים החשובים תייקו גם בארכיון של BizReady — כך הכל זמין בכל מקום`,
  ...
  },
  {
    ...
    category_id: "operations",
    pitfalls: [
      "לסמוך על הזיכרון — לקוח שנשכח הוא הכנסה שאבדה; עדכנו אחרי כל אינטראקציה.",
      "לשמור רשימת לקוחות בקובץ פתוח/לא מאובטח — זה מאגר מידע שחלות עליו חובות אבטחה.",
    ],
